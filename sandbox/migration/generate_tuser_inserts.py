...
f=open('../sybase/06142013/bcp.USERS', 'r')
accounts={}
for l in f:
  t=l.split('|')
  if t[0][0]=='B':
...
template_sql="insert into tUser(Username, DisplayName, Badge, IsBoothUser, Firm, IsQccTrader, Company) values (\'$username\', \'$displayname\', \'$badge\', 0, \'$firm\', 0, \'$company\');\n"
...
fileInserts=open('../out/insert_tUsers.sql', 'w')
